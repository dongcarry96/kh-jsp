...
<body>
	...
	<div class="easyui-layout" style="width: 1000px; height: 500px;">
		...
		<div data-options="region:'west',split:true" title="KH정보교육원"
			...
			if (s_name != null) {
			%>
			<%=s_name%>님 환영합니다. <a id="btn" href="javascript:logout()"
				class="easyui-linkbutton" data-options="iconCls:'icon-cancel'">로그아웃</a>
			<!-- 로그인을 하지 않았구나 -->
			<%
			} else {
			%>
			<table>
				<tr>
					<td><input id="tb_id" type="text" style="width: 120px"><br>
					</td>
					<td rowspan="2"><a id="btn" href="javascript:login()"
						class="easyui-linkbutton" style="width: 60px; height: 60px">로그인</a>
					</td>
				</tr>
				<tr>
					<td><input id="tb_pw" type="text" style="width: 120px">
					</td>
				</tr>
			</table>
			<%
