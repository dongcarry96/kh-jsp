...
<script type="text/javascript">
	...
	function memberList() {
		...
		let type = null;
		let keyword = null;
		if ($("#_easyui_textbox_input4").val() != null
				&& $("#_easyui_textbox_input4").val()) {
			type = "mem_id";
			keyword = $("#_easyui_textbox_input4").val();
		}
		if ($("#_easyui_textbox_input5").val() != null
				&& $("#_easyui_textbox_input5").val()) {
			type = "mem_name";
	...
	<div class="easyui-layout" style="width: 1000px; height: 500px;">
		...
		<div
			...
			<div id="d_member">
				...
				<!--[[ 회원목록 출력 ]]-->
				<table id="dg_member" class="easyui-datagrid" title="Basic DataGrid"
